    ...
    return (
        <HeroSection>
            <HeroContent>
                ...
                <HeroDescription>
                    Welcome to DANOVALAB — A Hub of Software Ingenuity! Bringing futuristic tech solutions to streamline
...
const TechIllustration = styled.div`
    ...
    width: 300px;
    height: 300px;
    background: url("https://via.placeholder.com/300.png?text=Tech") center/cover no-repeat;
    border-radius: 50%;
